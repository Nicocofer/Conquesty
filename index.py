    ...
    for line in file:
        if line.strip()=="<div class=\"boxP\" id=\"\"><div class=\"headP\"><div class=\"nameP\">Name planet</div><div class=\"close\" onclick=\"closebox()\"><span>X</span></div></div><div class=\"bodyP\"><div class=\"bodyP-top\"><div class=\"bodyP-left\"><div class=\"Pparam\">Type :</div><div class=\"Pparam\">Propriaitaire :</div><div class=\"Pparam\">Attaque :  <br> Defense :</div></div><div class=\"bodyP-right\"><div class=\"Pparam\">Systeme solaire : <br>Galaxie :</div><div class=\"Pparam\">Coordonnees<br> x :   / y :</div><div class=\"Pparam\">Population :</div></div></div><div class=\"bodyP-bottom\"><div class=\"Rtitle\">Ressouces de la planete</div><div class=\"ressources\"><div class=\"ressources-box\"><p id=\"metal\">metal :</p><p id=\"cristal\">cristal :</p></div><div class=\"ressources-box\"><p id=\"gaz\">gaz :</p><p id=\"energie\">energie :</p></div></div></div></div></div>":
            for planete in liste_planete_systeme:
                ...
                html= html +"<div class=\"boxP\" id=p\""+planete.id+"\"><div class=\"headP\"><div class=\"nameP\">"+planete.nom+"</div><div class=\"close\" onclick=\"closebox()\"><span>X</span></div></div><div class=\"bodyP\"><div class=\"bodyP-top\"><div class=\"bodyP-left\"><div class=\"Pparam\">Type :"+planete.type+"</div><div class=\"Pparam\">Propriaitaire :"+planete.id_proprio+"</div><div class=\"Pparam\">Attaque : "+planete.attaque+" <br> Defense :"+planete.armure+"</div></div><div class=\"bodyP-right\"><div class=\"Pparam\">Système solaire : "+planete.systeme+"<br>Galaxie :"+planete.galaxie+"</div><div class=\"Pparam\">Coordonnées<br> x : "+planete.x+"  / y : "+planete.y+"</div><div class=\"Pparam\">Population :"+planete.pop+"/"+planete.pop_max+"</div></div></div><div class=\"bodyP-bottom\"><div class=\"Rtitle\">Ressouces de la planète</div><div class=\"ressources\"><div class=\"ressources-box\"><p id=\"metal\">métal : "+planete.metal+"/"+planete.metal_max+"</p><p id=\"cristal\">cristal : "+planete.cristal+"/"+planete.cristal_max+"</p></div><div class=\"ressources-box\"><p id=\"gaz\">gaz : "+planete.gaz+"/"+planete.gaz_max+"</p><p id=\"energie\">energie :"+planete.energie+"</p></div></div></div></div></div>"
